...
namespace ERP.TRTBusinessZT.Web
{
    public class HttpHelper
    {
        ...
        /// <param name="heads">头</param>
        /// <param name="errorMessage">错误信息</param>
        /// <returns></returns>
        public static string DoPost(string url, string postData,string contentType,IDictionary<string,string> heads,ref string errorMessage)
        {
            try
            {
        ...
        /// <returns></returns>
        public static string DoGet(string url,string contentType, IDictionary<string, string> heads, ref string errorMessage)
        {
            try
            {
                string result = string.Empty;
